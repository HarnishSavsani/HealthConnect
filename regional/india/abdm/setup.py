...
from healthconnect.custom.doctype.custom_field.custom_field import create_custom_fields


def setup():
	if not healthconnect.db.exists("Custom Field", "Patient-abha_address"):
		make_custom_fields()
