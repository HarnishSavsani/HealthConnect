healthconnect.provide('healthconnect.ui.form');

healthconnect.ui.form.PatientQuickEntryForm = class PatientQuickEntryForm extends healthconnect.ui.form.QuickEntryForm {
	...
	get_standard_fields() {
		return [
			...
			},
			{
				...
				fieldtype: 'Select',
				options: healthconnect.meta.get_docfield('Patient', 'blood_group').options
			},
			{
