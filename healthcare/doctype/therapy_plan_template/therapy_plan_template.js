...
healthconnect.ui.form.on('Therapy Plan Template', {
	...
	linked_item: function (frm) {
		if (frm.doc.linked_item) {
			healthconnect.db.get_value('Item', frm.doc.linked_item, ['item_group', 'description', 'item_name'])
			.then(r => {
				frm.set_value({
...
healthconnect.ui.form.on('Therapy Plan Template Detail', {
	therapy_type: function(frm, cdt, cdn) {
		let row = locals[cdt][cdn];
		healthconnect.call('healthconnect.client.get', {
