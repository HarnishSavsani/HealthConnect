...
healthconnect.ui.form.on('Exercise Type', {
...
erpnext.ExerciseEditor = class ExerciseEditor {
	...
	show_add_card_dialog(frm) {
		...
		let d = new healthconnect.ui.Dialog({
			...
			primary_action: function() {
				...
				let step = healthconnect.model.add_child(frm.doc, 'Exercise Type Step', 'steps_table');
	...
	show_edit_card_dialog(frm, id) {
		let new_dialog = new healthconnect.ui.Dialog({
