...
healthconnect.ui.form.on('Clinical Procedure Template', {
	...
	item: function (frm) {
		if (frm.doc.item) {
			healthconnect.db.get_value('Item', frm.doc.item, ['item_group', 'description'])
			.then(r => {
				frm.set_value({
...
healthconnect.tour['Clinical Procedure Template'] = [
	{
		fieldname: 'template',
	...
	},
	{
		...
		description: __('Check this if the Clinical Procedure utilises consumables. Click ') + "<a href='https://healthconnecthealth.com/docs/v13/user/manual/en/healthcare/clinical_procedure_template#22-manage-procedure-consumables' target='_blank'>here</a>" + __(' to know more')
