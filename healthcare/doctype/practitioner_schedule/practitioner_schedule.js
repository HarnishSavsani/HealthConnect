...
healthconnect.ui.form.on('Practitioner Schedule', {
					...
					if (values) {
						...
						function add_slots(week_day) {
							...
							if (check_overlap_or_add_slot(week_day, cur_time, end_time, false)) {
								healthconnect.confirm(__('Schedules for {0} overlaps, do you want to proceed after skipping overlapped slots ?',	[week_day]),
									function() {
										// if Yes
