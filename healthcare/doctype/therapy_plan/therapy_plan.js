...
healthconnect.ui.form.on('Therapy Plan', {
	setup: function(frm) {
		...
		if (!frm.doc.__islocal) {
			...
			if (frm.doc.status != 'Completed') {
				...
				frm.add_custom_button(__('Therapy Session'), function() {
					healthconnect.prompt(fields, data => {
						healthconnect.call({
							...
							callback: function(r) {
								if (r.message) {
									healthconnect.model.sync(r.message);
									healthconnect.set_route('Form', r.message.doctype, r.message.name);
								}
							}
						});
	...
	make_sales_invoice: function(frm) {
		healthconnect.call({
			...
			callback: function(r) {
				var doclist = healthconnect.model.sync(r.message);
...
healthconnect.ui.form.on('Therapy Plan Detail', {
