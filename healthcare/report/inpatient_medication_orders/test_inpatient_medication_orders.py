...
from healthconnect.utils import getdate, now_datetime
...
class TestInpatientMedicationOrders(healthconnectTestCase):
	@classmethod
	def setUpClass(self):
		healthconnect.db.sql("delete from `tabInpatient Medication Order` where company='_Test Company'")
		healthconnect.db.sql("delete from `tabInpatient Medication Entry` where company='_Test Company'")
